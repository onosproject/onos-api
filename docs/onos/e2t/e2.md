...
| instance_id | [string](#string) |  | instance_id is an identifier unique to a single node within the application that created the channel |
| node_id | [string](#string) |  | node_id is the identifier for the E2 node to which the subscription is targeted |
...
| ListChannels | [ListChannelsRequest](#onos.e2t.e2.v1beta1.ListChannelsRequest) | [ListChannelsResponse](#onos.e2t.e2.v1beta1.ListChannelsResponse) stream |  |
...
| ListSubscriptions | [ListSubscriptionsRequest](#onos.e2t.e2.v1beta1.ListSubscriptionsRequest) | [ListSubscriptionsResponse](#onos.e2t.e2.v1beta1.ListSubscriptionsResponse) stream |  |
