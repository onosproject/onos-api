...
type Transaction struct {
	...
	*TargetVersionOverrides `protobuf:"bytes,9,opt,name=version_overrides,json=versionOverrides,proto3,embedded=version_overrides" json:"version_overrides,omitempty"`
}
...
var fileDescriptor_c3a2d73bdadccc35 = []byte{
	...
	,
}
...
func (m *Transaction) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.TargetVersionOverrides != nil {
		{
			size, err := m.TargetVersionOverrides.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *TransactionPhaseStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Start != nil {
		...
		i -= n16
		i = encodeVarintTransaction(dAtA, i, uint64(n16))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Transaction) Size() (n int) {
	...
	n += 1 + l + sovTransaction(uint64(l))
	if m.TargetVersionOverrides != nil {
		l = m.TargetVersionOverrides.Size()
		n += 1 + l + sovTransaction(uint64(l))
	}
	return n
}
...
func (m *Transaction) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TargetVersionOverrides", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.TargetVersionOverrides == nil {
				m.TargetVersionOverrides = &TargetVersionOverrides{}
			}
			if err := m.TargetVersionOverrides.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
