...
type Proposal struct {
	...
	TransactionIndex Index `protobuf:"varint,5,opt,name=transaction_index,json=transactionIndex,proto3,casttype=Index" json:"transaction_index,omitempty"`
	...
	Status ProposalStatus `protobuf:"bytes,8,opt,name=status,proto3" json:"status"`
}
...
type Proposal_Change struct {
	Change *ChangeProposal `protobuf:"bytes,6,opt,name=change,proto3,oneof" json:"change,omitempty"`
}
type Proposal_Rollback struct {
	Rollback *RollbackProposal `protobuf:"bytes,7,opt,name=rollback,proto3,oneof" json:"rollback,omitempty"`
}
...
func (m *Proposal) GetTransactionID() TransactionID {
	if m != nil {
...
type ChangeProposal struct {
	...
	Values map[string]ChangeValue `protobuf:"bytes,3,rep,name=values,proto3" json:"values" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *ChangeProposal) GetTargetVersion() TargetVersion {
	if m != nil {
...
func (m *ChangeProposal) GetTargetType() TargetType {
	if m != nil {
		return m.TargetType
	}
	return ""
...
func (m *ChangeProposal) GetValues() map[string]ChangeValue {
	if m != nil {
		return m.Values
	}
	return nil
...
type ProposalStatus struct {
	...
	RollbackValues map[string]ChangeValue `protobuf:"bytes,5,rep,name=rollback_values,json=rollbackValues,proto3" json:"rollback_values" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *ProposalStatus) GetRollbackValues() map[string]ChangeValue {
	if m != nil {
...
func init() {
	...
	proto.RegisterMapType((map[string]ChangeValue)(nil), "onos.config.v2.ChangeProposal.ValuesEntry")
	...
	proto.RegisterMapType((map[string]ChangeValue)(nil), "onos.config.v2.ProposalStatus.RollbackValuesEntry")
...
var fileDescriptor_4000ba20b19ba7e8 = []byte{
	...
	,
}
...
func (m *Proposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TransactionID) > 0 {
		...
		i = encodeVarintProposal(dAtA, i, uint64(len(m.TransactionID)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.TargetID) > 0 {
...
func (m *ChangeProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TargetType) > 0 {
		...
		i = encodeVarintProposal(dAtA, i, uint64(len(m.TargetType)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.TargetVersion) > 0 {
		...
		i = encodeVarintProposal(dAtA, i, uint64(len(m.TargetVersion)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *ProposalPhaseStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.End != nil {
		...
		i -= n12
		i = encodeVarintProposal(dAtA, i, uint64(n12))
		i--
		dAtA[i] = 0x12
	}
	if m.Start != nil {
...
func (m *ChangeProposal) Size() (n int) {
	...
	if len(m.Values) > 0 {
		for k, v := range m.Values {
			...
			_ = v
			l = v.Size()
			mapEntrySize := 1 + len(k) + sovProposal(uint64(len(k))) + 1 + l + sovProposal(uint64(l))
	...
	for iNdEx < l {
		...
		case 5:
			...
			if m.RollbackValues == nil {
				m.RollbackValues = make(map[string]ChangeValue)
			}
			var mapkey string
			mapvalue := &ChangeValue{}
			for iNdEx < postIndex {
