...
type ChangeProposal struct {
	...
	Values map[string]PathValue `protobuf:"bytes,1,rep,name=values,proto3" json:"values" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
type ProposalStatus struct {
	...
	RollbackValues map[string]PathValue `protobuf:"bytes,5,rep,name=rollback_values,json=rollbackValues,proto3" json:"rollback_values" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var fileDescriptor_4000ba20b19ba7e8 = []byte{
	...
	,
}
