...
import (
	...
	github_com_onosproject_onos_api_proto_config_device "github.com/onosproject/onos-api/proto/config/device"
...
type Change struct {
	...
	DeviceID github_com_onosproject_onos_api_proto_config_device.ID `protobuf:"bytes,1,opt,name=device_id,json=deviceId,proto3,casttype=github.com/onosproject/onos-api/proto/config/device.ID" json:"device_id,omitempty"`
	// 'device_version' is an optional device version to which to apply this change
	DeviceVersion github_com_onosproject_onos_api_proto_config_device.Version `protobuf:"bytes,2,opt,name=device_version,json=deviceVersion,proto3,casttype=github.com/onosproject/onos-api/proto/config/device.Version" json:"device_version,omitempty"`
	// 'device_type' is an optional device type to which to apply this change
	DeviceType github_com_onosproject_onos_api_proto_config_device.Type `protobuf:"bytes,3,opt,name=device_type,json=deviceType,proto3,casttype=github.com/onosproject/onos-api/proto/config/device.Type" json:"device_type,omitempty"`
...
func (m *Change) GetDeviceID() github_com_onosproject_onos_api_proto_config_device.ID {
	if m != nil {
		return m.DeviceID
	}
	return ""
...
func (m *Change) GetDeviceVersion() github_com_onosproject_onos_api_proto_config_device.Version {
	if m != nil {
...
func (m *Change) GetDeviceType() github_com_onosproject_onos_api_proto_config_device.Type {
	if m != nil {
		return m.DeviceType
	}
	return ""
...
var fileDescriptor_dc5cf8139a7073fc = []byte{
	...
	,
}
...
func (m *Change) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.DeviceID = github_com_onosproject_onos_api_proto_config_device.ID(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			m.DeviceVersion = github_com_onosproject_onos_api_proto_config_device.Version(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			m.DeviceType = github_com_onosproject_onos_api_proto_config_device.Type(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
