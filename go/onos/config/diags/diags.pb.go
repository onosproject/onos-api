...
import (
	...
	network "onos/config/types/change/network"
	onos_config_types_change_network "onos/config/types/change/network"
	onos_config_types_device "onos/config/types/device"
)
...
type ListNetworkChangeRequest struct {
	...
	ChangeID onos_config_types_change_network.ID `protobuf:"bytes,2,opt,name=changeid,proto3,casttype=onos/config/types/change/network.ID" json:"changeid,omitempty"`
...
func (m *ListNetworkChangeRequest) GetChangeID() onos_config_types_change_network.ID {
	if m != nil {
		return m.ChangeID
	}
	return ""
...
type ListDeviceChangeRequest struct {
	...
	// Can support `*` (match many chars) or '?' (match one char) as wildcard
	DeviceID onos_config_types_device.ID `protobuf:"bytes,2,opt,name=device_id,json=deviceId,proto3,casttype=onos/config/types/device.ID" json:"device_id,omitempty"`
	// device_version is an optional device version
	DeviceVersion onos_config_types_device.Version `protobuf:"bytes,3,opt,name=device_version,json=deviceVersion,proto3,casttype=onos/config/types/device.Version" json:"device_version,omitempty"`
	// option to request only changes that happen after the call
...
func (m *ListDeviceChangeRequest) GetDeviceID() onos_config_types_device.ID {
	if m != nil {
		return m.DeviceID
	}
	return ""
...
func (m *ListDeviceChangeRequest) GetDeviceVersion() onos_config_types_device.Version {
	if m != nil {
...
var fileDescriptor_33a12a4c5a708a34 = []byte{
	...
	,
}
...
func (m *ListNetworkChangeRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.ChangeID = onos_config_types_change_network.ID(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 0 {
...
func (m *ListDeviceChangeRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.DeviceID = onos_config_types_device.ID(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			m.DeviceVersion = onos_config_types_device.Version(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field WithoutReplay", wireType)
