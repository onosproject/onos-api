...
import (
	...
	github_com_onosproject_onos_api_proto_config_snapshot_device "github.com/onosproject/onos-api/proto/config/snapshot/device"
...
type ListSnapshotsRequest struct {
	...
	ID github_com_onosproject_onos_api_proto_config_snapshot_device.ID `protobuf:"bytes,2,opt,name=id,proto3,casttype=github.com/onosproject/onos-api/proto/config/snapshot/device.ID" json:"id,omitempty"`
}
...
func (m *ListSnapshotsRequest) GetID() github_com_onosproject_onos_api_proto_config_snapshot_device.ID {
	if m != nil {
		return m.ID
	}
	return ""
...
var fileDescriptor_1fd496319a120412 = []byte{
	...
	,
}
...
func (m *ListSnapshotsRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.ID = github_com_onosproject_onos_api_proto_config_snapshot_device.ID(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipAdmin(dAtA[iNdEx:])
