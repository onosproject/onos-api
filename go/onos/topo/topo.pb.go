...
const (
	RelationFilterScope_TARGETS_ONLY          RelationFilterScope = 0
	RelationFilterScope_ALL                   RelationFilterScope = 1
	RelationFilterScope_SOURCE_AND_TARGETS    RelationFilterScope = 2
	RelationFilterScope_RELATIONS_ONLY        RelationFilterScope = 3
	RelationFilterScope_RELATIONS_AND_TARGETS RelationFilterScope = 4
)

var RelationFilterScope_name = map[int32]string{
	0: "TARGETS_ONLY",
	1: "ALL",
	2: "SOURCE_AND_TARGETS",
	3: "RELATIONS_ONLY",
	4: "RELATIONS_AND_TARGETS",
}
...
func (Object_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_4aa6a08a9884ea40, []int{21, 0}
}
...
func (m *RelationFilter) GetScope() RelationFilterScope {
	...
	return RelationFilterScope_TARGETS_ONLY
}
...
func (m *QueryRequest) GetFilters() *Filters {
	if m != nil {
		return m.Filters
	}
	return nil
...
func (m *QueryResponse) GetObject() *Object {
	if m != nil {
		return m.Object
	}
	return nil
...
func (*Relation) Descriptor() ([]byte, []int) {
	return fileDescriptor_4aa6a08a9884ea40, []int{23}
}
...
func (*Kind) Descriptor() ([]byte, []int) {
	return fileDescriptor_4aa6a08a9884ea40, []int{24}
}
...
func init() {
	...
	proto.RegisterType((*QueryRequest)(nil), "onos.topo.QueryRequest")
	proto.RegisterType((*QueryResponse)(nil), "onos.topo.QueryResponse")
...
var fileDescriptor_4aa6a08a9884ea40 = []byte{
	...
	,
}
...
type TopoClient interface {
	...
	Query(ctx context.Context, in *QueryRequest, opts ...grpc.CallOption) (Topo_QueryClient, error)
...
func (c *topoClient) Query(ctx context.Context, in *QueryRequest, opts ...grpc.CallOption) (Topo_QueryClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Topo_serviceDesc.Streams[0], "/onos.topo.Topo/Query", opts...)
	if err != nil {
		return nil, err
	}
	x := &topoQueryClient{stream}
...
type Topo_QueryClient interface {
	Recv() (*QueryResponse, error)
	grpc.ClientStream
}

type topoQueryClient struct {
	grpc.ClientStream
}

func (x *topoQueryClient) Recv() (*QueryResponse, error) {
	m := new(QueryResponse)
...
func (c *topoClient) Watch(ctx context.Context, in *WatchRequest, opts ...grpc.CallOption) (Topo_WatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Topo_serviceDesc.Streams[1], "/onos.topo.Topo/Watch", opts...)
	if err != nil {
		return nil, err
	}
...
type TopoServer interface {
	...
	// Query gets a stream of requested objects
	Query(*QueryRequest, Topo_QueryServer) error
	// DEPRECATED: List gets a list of requested objects
...
func (*UnimplementedTopoServer) Query(req *QueryRequest, srv Topo_QueryServer) error {
...
func _Topo_Query_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(QueryRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(TopoServer).Query(m, &topoQueryServer{stream})
}

type Topo_QueryServer interface {
	Send(*QueryResponse) error
	grpc.ServerStream
}

type topoQueryServer struct {
	grpc.ServerStream
}

func (x *topoQueryServer) Send(m *QueryResponse) error {
