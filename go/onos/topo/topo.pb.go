...
func (Object_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_4aa6a08a9884ea40, []int{14, 0}
}
...
type Filter struct {
	LabelQuery  string `protobuf:"bytes,1,opt,name=label_query,json=labelQuery,proto3" json:"label_query,omitempty"`
	AspectQuery string `protobuf:"bytes,2,opt,name=aspect_query,json=aspectQuery,proto3" json:"aspect_query,omitempty"`
	KindQuery   string `protobuf:"bytes,3,opt,name=kind_query,json=kindQuery,proto3" json:"kind_query,omitempty"`
}
...
func (m *Filter) GetLabelQuery() string {
	if m != nil {
		return m.LabelQuery
	}
	return ""
...
func (m *Filter) GetAspectQuery() string {
	if m != nil {
		return m.AspectQuery
	}
	return ""
}

func (m *Filter) GetKindQuery() string {
	if m != nil {
		return m.KindQuery
	}
	return ""
...
func (m *WatchRequest) GetFilter() *Filter {
	if m != nil {
		return m.Filter
	}
	return nil
...
var fileDescriptor_4aa6a08a9884ea40 = []byte{
	...
	,
}
...
func (m *Filter) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.KindQuery) > 0 {
		i -= len(m.KindQuery)
		copy(dAtA[i:], m.KindQuery)
		i = encodeVarintTopo(dAtA, i, uint64(len(m.KindQuery)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.AspectQuery) > 0 {
		i -= len(m.AspectQuery)
		copy(dAtA[i:], m.AspectQuery)
		i = encodeVarintTopo(dAtA, i, uint64(len(m.AspectQuery)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.LabelQuery) > 0 {
		i -= len(m.LabelQuery)
		copy(dAtA[i:], m.LabelQuery)
		i = encodeVarintTopo(dAtA, i, uint64(len(m.LabelQuery)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Filter) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.LabelQuery = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AspectQuery", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AspectQuery = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field KindQuery", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.KindQuery = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTopo(dAtA[iNdEx:])
