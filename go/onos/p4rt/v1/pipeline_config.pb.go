...
type PipelineConfigState int32

const (
	// PIPELINE_CONFIG_PENDING indicates the pipeline configuration phase is pending
	PipelineConfigState_PIPELINE_CONFIG_PENDING PipelineConfigState = 0
	// PIPELINE_CONFIG_COMPLETE indicates the pipeline configuration phase is complete
	PipelineConfigState_PIPELINE_CONFIG_COMPLETE PipelineConfigState = 1
	// PIPELINE_CONFIG_FAILED indicates the pipeline configuration phase failed
	PipelineConfigState_PIPELINE_CONFIG_FAILED PipelineConfigState = 2
)

var PipelineConfigState_name = map[int32]string{
	0: "PIPELINE_CONFIG_PENDING",
	1: "PIPELINE_CONFIG_COMPLETE",
	2: "PIPELINE_CONFIG_FAILED",
}

var PipelineConfigState_value = map[string]int32{
	"PIPELINE_CONFIG_PENDING":  0,
	"PIPELINE_CONFIG_COMPLETE": 1,
	"PIPELINE_CONFIG_FAILED":   2,
}

func (x PipelineConfigState) String() string {
	return proto.EnumName(PipelineConfigState_name, int32(x))
}

func (PipelineConfigState) EnumDescriptor() ([]byte, []int) {
...
type PipelineConfigStatus struct {
	...
	State PipelineConfigState `protobuf:"varint,1,opt,name=state,proto3,enum=onos.p4rt.v1.PipelineConfigState" json:"state,omitempty"`
...
func (m *PipelineConfigStatus) GetState() PipelineConfigState {
	if m != nil {
		return m.State
	}
	return PipelineConfigState_PIPELINE_CONFIG_PENDING
}
...
func init() {
	proto.RegisterEnum("onos.p4rt.v1.PipelineConfigState", PipelineConfigState_name, PipelineConfigState_value)
...
var fileDescriptor_6080f98dc2058397 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.State |= PipelineConfigState(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
