...
type EmitLLDPPacketRequest struct {
	...
	IngressPort uint32 `protobuf:"varint,3,opt,name=ingress_port,json=ingressPort,proto3" json:"ingress_port,omitempty"`
	RoleAgentId uint32 `protobuf:"varint,4,opt,name=role_agent_id,json=roleAgentId,proto3" json:"role_agent_id,omitempty"`
}
...
func (m *EmitLLDPPacketRequest) GetIngressPort() uint32 {
	if m != nil {
...
func (m *EmitLLDPPacketRequest) GetRoleAgentId() uint32 {
	if m != nil {
		return m.RoleAgentId
	}
	return 0
}
...
var fileDescriptor_7db16019df22577e = []byte{
	...
	,
}
...
func (m *EmitLLDPPacketRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.RoleAgentId != 0 {
		i = encodeVarintDevices(dAtA, i, uint64(m.RoleAgentId))
		i--
		dAtA[i] = 0x20
	}
	if m.IngressPort != 0 {
		i = encodeVarintDevices(dAtA, i, uint64(m.IngressPort))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Packet) > 0 {
...
func (m *EmitLLDPPacketRequest) Size() (n int) {
	...
	if m.IngressPort != 0 {
		n += 1 + sovDevices(uint64(m.IngressPort))
	}
	if m.RoleAgentId != 0 {
		n += 1 + sovDevices(uint64(m.RoleAgentId))
	}
	return n
}
...
func (m *EmitLLDPPacketRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IngressPort", wireType)
			}
			m.IngressPort = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.IngressPort |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RoleAgentId", wireType)
			}
			m.RoleAgentId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RoleAgentId |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
