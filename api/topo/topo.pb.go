...
type ProtocolState struct {
	...
	Protocol Protocol `protobuf:"varint,1,opt,name=protocol,proto3,enum=topo.Protocol" json:"protocol,omitempty"`
	//ConnectivityState contains the L3 connectivity information
	ConnectivityState ConnectivityState `protobuf:"varint,2,opt,name=connectivityState,proto3,enum=topo.ConnectivityState" json:"connectivityState,omitempty"`
	//ChannelState relates to the availability of the gRPC channel
	ChannelState ChannelState `protobuf:"varint,3,opt,name=channelState,proto3,enum=topo.ChannelState" json:"channelState,omitempty"`
	//ServiceState indicates the availability of the gRPC servic on top of the channel
	ServiceState ServiceState `protobuf:"varint,4,opt,name=serviceState,proto3,enum=topo.ServiceState" json:"serviceState,omitempty"`
}
...
func (*ProtocolState) Descriptor() ([]byte, []int) {
	return fileDescriptor_5823f9f54b50fd8c, []int{17}
}
...
func init() {
	...
	proto.RegisterEnum("topo.Protocol", Protocol_name, Protocol_value)
	proto.RegisterEnum("topo.ConnectivityState", ConnectivityState_name, ConnectivityState_value)
	proto.RegisterEnum("topo.ChannelState", ChannelState_name, ChannelState_value)
	proto.RegisterEnum("topo.ServiceState", ServiceState_name, ServiceState_value)
	...
	proto.RegisterType((*ProtocolState)(nil), "topo.ProtocolState")
}
...
var fileDescriptor_5823f9f54b50fd8c = []byte{
	...
	,
}
