...
# sources: onos/config/v2/configuration.proto, onos/config/v2/transaction.proto, onos/config/v2/types.proto
...
class FailureReasonTransactionType(betterproto.Enum):
    UNSPECIFIED = 0
    ERROR = 1
...
class TransactionStatus(betterproto.Message):
    ...
    failure_reason: "FailureReason" = betterproto.message_field(3)
    # message is a result message
    message: str = betterproto.string_field(4)


@dataclass(eq=False, repr=False)
class FailureReason(betterproto.Message):
    """FailureReason failure reason"""

    cause: "FailureReasonCause" = betterproto.message_field(1)


@dataclass(eq=False, repr=False)
class FailureReasonCause(betterproto.Message):
    validation: "FailureReasonValidation" = betterproto.message_field(1, group="cause")
    transaction: "FailureReasonTransaction" = betterproto.message_field(
        2, group="cause"
    )


@dataclass(eq=False, repr=False)
class FailureReasonValidation(betterproto.Message):
    type: "FailureReasonValidationType" = betterproto.enum_field(1)
